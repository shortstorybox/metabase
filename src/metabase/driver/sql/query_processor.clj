...
(defmethod ->honeysql [:sql :percent-of-total] [driver [_ field]] (hsql/call :ratio-to-report (->honeysql driver [:sum field])))
(defmethod ->honeysql [:sql :stddev]     [driver [_ field]]   (hsql/call :stddev_samp     (->honeysql driver field)))
(defmethod ->honeysql [:sql :var]        [driver [_ field]]   (hsql/call :var_samp        (->honeysql driver field)))
...
(defmethod ->honeysql [:sql :ratio-to-report] [driver [_ field]] (hsql/call :ratio-to-report (->honeysql driver field)))
